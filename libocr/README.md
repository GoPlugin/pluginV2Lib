...
You may also be interested in [libocr's integration into the actual Chainlink node](https://github.com/Goplugin/PluginV2Lib/chainlink/tree/develop/core/services/offchainreporting).
