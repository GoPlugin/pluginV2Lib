...
import (
	...
	"github.com/pluginV2-relay/pkg/logger"
)

// Mercury-specific reporting plugin, based off of median:
// https://github.com/GoPlugin/pluginV2Lib/offchain-reporting/blob/master/lib/offchainreporting2/reportingplugin/median/median.go
